...
(function popUpModule() {
  ...
  const resetPopUpElements = () => {
    document
      .querySelectorAll(".pop-up__modal-container")
      .forEach((e) => e.remove());

    document
      .querySelectorAll(".pop-up__button")
      // eslint-disable-next-line no-return-assign
      .forEach((btn) => (btn.textContent = "+"));

    document
      .querySelectorAll(".pop-up__block")
  ...
  const createModal = (button, block) => {
    ...
    modalContainer.style.top = button.getAttribute("data-position-top") + "px";
  ...
  popUpBlocks.forEach((block) => {
    block.addEventListener("click", () => {
      ...
      const existingModalContainer = block.querySelector(
        ".pop-up__modal-container"
      );
...
(function formModule() {
  ...
  form.addEventListener("submit", (event) => {
    ...
    isFormValid = validateInput(emailInput, emailRegex) && isFormValid;
